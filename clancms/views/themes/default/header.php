...
<div id="header">
	...
	<div id="banner"><?php if($this->ClanCMS->get_setting('logo') == 1): ?><?php echo anchor('', img(array('src' => THEME_URL . 'images/thmc_baseball_logo.gif', 'alt' => 'Logo', 'id' => 'logo'))); ?><?php elseif($this->ClanCMS->get_setting('logo') == 2): ?><?php echo anchor('', '<h1>' . CLAN_NAME . '</h1><h2>' . $this->ClanCMS->get_setting('clan_slogan') . '</h2>'); ?><?php endif; ?></div>
	<div id="navigation">
	<ul>
